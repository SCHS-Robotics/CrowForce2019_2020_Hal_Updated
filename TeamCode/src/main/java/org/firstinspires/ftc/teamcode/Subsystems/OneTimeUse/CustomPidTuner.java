 ...
 */
public class CustomPidTuner extends VisionSubSystem {
    ...
    private CustomMechinumDrive mechanumDrive;
     ...
     */
    public CustomPidTuner(Robot robot, BaseParam driveParams, PIDController pidController, double setPoint, AngleUnit angleUnit) {
        super(robot);
        ...
        switch(driveType) {
            ...
            case MECHANUM: mechanumDrive = new CustomMechinumDrive(robot, (CustomMechinumDrive.Params) driveParams);
                mechanumDrive.getMotors()[0].setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
                mechanumDrive.getMotors()[1].setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
                mechanumDrive.getMotors()[2].setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
                mechanumDrive.getMotors()[3].setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
            break;
